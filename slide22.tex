...
\frame
{
 ...
 \begin{itemize}
            ...
            \item<1->[] \begin{Theorem}[The Continuity Theorem] Let $\mu, \mu_1, \mu_2,\cdots$  be probability measures with characteristic functions $\phi, \phi_1, \phi_2,\cdots$. Then $\mu_n$ converges weakly to $\mu$ if and only if $\phi_n(t)\rightarrow \phi(t)$ for all $t \in \mathbf{R}$.  That is, the weak convergence is equivalent to the pointwise convergence of characteristic function. \end{Theorem}
