...
\frame
{
  \frametitle{Large Deviations Theory and Moment Generating functions} 
   ...
   \begin{itemize}
                 ...
                 \item<1->[] \begin{Theorem}[Large Deviation Theorem for LLN] Let $X_1, X_2,\ldots$ be i.i.d. random variables with mean $\mu$, and $M_{X_i}(s) <\infty $ for $s\in (-a, b)$ where $a, b>0$. Then 
